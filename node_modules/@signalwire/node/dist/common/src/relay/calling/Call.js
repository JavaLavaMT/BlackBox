...
class Call {
    ...
    pass() {
        return __awaiter(this, void 0, void 0, function* () {
            const component = new components_1.Pass(this);
            this._addComponent(component);
            const { code, message } = yield component.execute();
            component.completed = true;
            component.successful = code === '200';
            component.event = new Event_1.default('response', { code, message });
            return new results_1.PassResult(component);
        });
    }
    record(record = {}) {
        return __awaiter(this, void 0, void 0, function* () {
